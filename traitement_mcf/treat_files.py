...
# os.path.join(os.path.dirname(__file__), "data_formation.json")
file = os.path.join(os.path.dirname(__file__), "data/data_formation.json")  # Path to the most recent json
# file = "/mnt/azure/data_formation.json"  # Path to the most recent json
...
def get_dataframe(file: str = file):
    ...
    Parameter(s):
                    By default : `TRAITEMENT_MCF/data/data_formation.json`
